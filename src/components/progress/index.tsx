import React, { ReactNode, PropsWithChildren, useState, useMemo, useEffect } from 'react'
import styled, { CSSProperties } from 'styled-components'
import { progressFlash } from '../shared/animation'
import { BarWrapperProps } from './types'
...
const BarBox = styled.div<BarWrapperProps>`
...
const BarBoxWrapper = styled.div<{ bottomColor: string; height?: number }>`
	width: 100%;
	border-radius: 5px;
	position: relative;
		...
		if (circle) {
			...
			return (
				<BarWrapper style={style} className={classname}>
					<BarBoxWrapper bottomColor={bottomColor!} height={height}>
						<BarBox
