...
const testAutoplay = function() {
	return (
		<Carousel viewportBoxShadow='10px' height={300} autoplayDelay={1000}>
...
const testReverseAuto = function() {
	return (
		<Carousel viewportBoxShadow='10px' height={300} autoplayDelay={1000} autoplayReverse={true}>
			<span id="test1">1</span>
			<span id="test2">2</span>
			<span id="test3">3</span>
		</Carousel>
...
const testHeight = function() {
	return (
		<Carousel viewportBoxShadow='10px' height={100} autoplay={false}>
			<span id="test1">1</span>
			<span id="test2">2</span>
			<span id="test3">3</span>
		</Carousel>
...
const testDefaultIndex = function() {
	return (
		<Carousel viewportBoxShadow='10px' height={100} autoplay={false} defaultIndex={2}>
			<span id="test1">1</span>
			<span id="test2">2</span>
			<span id="test3">3</span>
		</Carousel>
...
const testRadioColor = function() {
	return (
		<div>
			<Carousel viewportBoxShadow='10px' height={100} autoplay={false} radioAppear="positive">
				<span id="test1">1</span>
				<span id="test2">2</span>
				<span id="test3">3</span>
			</Carousel>
			...
			<Carousel viewportBoxShadow='10px' height={100} autoplay={false} radioAppear="purple">
				<span id="test1">1</span>
				<span id="test2">2</span>
				<span id="test3">3</span>
			</Carousel>
